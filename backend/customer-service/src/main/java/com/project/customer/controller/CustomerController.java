...
public class CustomerController {
    ...
    @Operation(
        ...
        description = "Creates a new customer using national ID and personal information.",
    ...
    @Operation(
        ...
        description = "Retrieves a customer using database ID."
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        ...
        description = "Updates customer personal information.",
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
    ...
    @Operation(
        ...
        description = "Deletes a customer permanently by ID."
    )
    @ApiResponses({
    ...
    @Operation(
        summary = "Search customer by National ID",
        description = "Searches for a customer using their national ID."
    )
    @ApiResponses({
    ...
    public ResponseEntity<CustomerResponse> searchCustomerByNationalId(
            @Parameter(
                description = "National ID must be exactly 9 digits (numeric only)",
                example = "987654321",
                schema = @Schema(
                    pattern = "^[0-9]{9}$",
                    minLength = 9,
    ...
    @Operation(
        summary = "Admin: Update customer National ID",
        description = "Allows ADMIN to update customer's National ID."
    )
    @ApiResponses({
